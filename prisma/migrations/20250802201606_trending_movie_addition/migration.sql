-- AlterTable
ALTER TABLE "CastsOnMovies" ADD COLUMN     "trendingId" INTEGER;

-- AlterTable
ALTER TABLE "FavouriteCartMovies" ADD COLUMN     "trendingId" INTEGER;

-- AlterTable
ALTER TABLE "MovieReviews" ADD COLUMN     "trendingId" INTEGER;

-- AlterTable
ALTER TABLE "WatchCartMovies" ADD COLUMN     "trendingId" INTEGER;
